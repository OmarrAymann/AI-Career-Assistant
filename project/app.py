...
manual_skills = st.text_area("Or type your skills (comma-separated)", placeholder="E.g., Python, SQL, Docker, etc...")
...
user_name = st.text_input("📝 Your Name", value="Omar Ayman")
position_title = st.text_input("🎯 Job Title", value="Machine Learning Engineer")
...
if st.button("Generate Match Score & Cover Letter"):
    ...
    "series": [{
        ...
        "axisLine": {
            "lineStyle": {
                "width": 18,
                "color": [[1, "#e5e7eb"]]  # Tailwind gray-200
            }
        },
        "pointer": {
            "show": False  # Hides the arrow
        },
        "axisTick": {"show": False},
        "splitLine": {"show": False},
        "axisLabel": {"show": False},
        "anchor": {
            "show": False  # Hides the central circle/anchor
        },
        "title": {
            "show": True,
            "offsetCenter": [0, "-30%"],
